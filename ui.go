...
func managementHTML(cfg runtimeConfig) (page string) {
	defer func() {
		page = strings.NewReplacer(
			...
			"越小越省上下文；越大保留更多历史细节。", "用于规划摘要检查点大小；越小越省上下文，越大保留更多细节，不会作为模型输出 token 上限下发。",
